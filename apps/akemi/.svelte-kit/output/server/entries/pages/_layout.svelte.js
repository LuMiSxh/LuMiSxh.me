import { c as create_ssr_component, a as add_attribute, e as escape, b as compute_slots, s as setContext, w as writable, d as compute_rest_props, f as createEventDispatcher, g as getContext, h as subscribe, i as spread, j as escape_object, k as is_void, v as validate_component } from '../../chunks/index.js';
import { p as page, I as Icon } from '../../chunks/Icon.js';
...
const icons = {
    ...
    // Source: https://fontawesome.com/icons/magnifying-glass?s=solid&f=classic
    search: {
        viewBox: '0 0 512 512',
...
/* C:/Users/Schmi/Projects/lumisxh_master/node_modules/.pnpm/@skeletonlabs+skeleton@0.80.8/node_modules/@skeletonlabs/skeleton/components/SvgIcon/SvgIcon.svelte generated by Svelte v3.55.0 */
const cBase$2 = 'inline-block outline-none';
...
const SvgIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	classesBase = `${cBase$2} ${fill} ${width} ${height}`;

	return `
<svg xmlns="${"http://www.w3.org/2000/svg"}"${add_attribute("x", x, 0)}${add_attribute("y", y, 0)}${add_attribute("viewBox", viewBox, 0)} class="${"svg-icon " + escape(classesBase, true) + " " + escape($$props.class ?? '', true)}" focusable="${"false"}" data-testid="${"svg-icon"}">${title ? `<title>${escape(title)}</title>` : ``}${$$slots.default
	? `${slots.default ? slots.default({}) : ``}`
	: `<path${add_attribute("d", icons[name].path, 0)}></path>`}</svg>`;
});

/* C:/Users/Schmi/Projects/lumisxh_master/node_modules/.pnpm/@skeletonlabs+skeleton@0.80.8/node_modules/@skeletonlabs/skeleton/components/AppRail/AppRail.svelte generated by Svelte v3.55.0 */
const cBase$1 = 'grid grid-rows-[auto_1fr_auto] overflow-y-auto';

const AppRail = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	let classesBase;
	let { selected = writable(undefined) } = $$props;
...
/* C:/Users/Schmi/Projects/lumisxh_master/node_modules/.pnpm/@skeletonlabs+skeleton@0.80.8/node_modules/@skeletonlabs/skeleton/components/AppRail/AppRailTile.svelte generated by Svelte v3.55.0 */
...
const AppRailTile = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.regionIcon === void 0 && $$bindings.regionIcon && regionIcon !== void 0) $$bindings.regionIcon(regionIcon);
	if ($$props.regionLabel === void 0 && $$bindings.regionLabel && regionLabel !== void 0) $$bindings.regionLabel(regionLabel);
	if ($$props.selected === void 0 && $$bindings.selected && selected !== void 0) $$bindings.selected(selected);
	if ($$props.active === void 0 && $$bindings.active && active !== void 0) $$bindings.active(active);
	if ($$props.hover === void 0 && $$bindings.hover && hover !== void 0) $$bindings.hover(hover);

	classesActive = $selected && value && $selected === value
	? `${active}`
	: '';
...
${(tag$1 => {
	...
	${label
				? `<div class="${"app-rail-tile-label " + escape(regionLabel, true)}">${escape(label)}</div>`
				: ``}`}${is_void(tag$1) ? '' : `</${tag$1}>`}`
		: '';
	})(tag)}`;
});

/* C:/Users/Schmi/Projects/lumisxh_master/node_modules/.pnpm/@skeletonlabs+skeleton@0.80.8/node_modules/@skeletonlabs/skeleton/components/AppShell/AppShell.svelte generated by Svelte v3.55.0 */
...
const AppShell = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	${$$slots.header
	? `<header id="${"shell-header"}" class="${"flex-none " + escape(classesheader, true)}">${slots.header ? slots.header({}) : ``}</header>`
	: ``}

	
	<div class="${"flex-auto " + escape(cContentArea, true)}">
		${$$slots.sidebarLeft
	? `<aside id="${"sidebar-left"}"${add_attribute("class", classesSidebarLeft, 0)}>${slots.sidebarLeft ? slots.sidebarLeft({}) : ``}</aside>`
	: ``}

		
		<div id="${"page"}"${add_attribute("class", cPage, 0)}>
			${$$slots.pageHeader
	? `<header id="${"page-header"}" class="${"flex-none " + escape(classesPageHeader, true)}">${slots.pageHeader
		? slots.pageHeader({})
		: `(slot:header)`}</header>`
	: ``}
			...
			${$$slots.pageFooter
	? `<footer id="${"page-footer"}" class="${"flex-none " + escape(classesPageFooter, true)}">${slots.pageFooter
		? slots.pageFooter({})
		: `(slot:footer)`}</footer>`
	: ``}</div>
		...
		${$$slots.sidebarRight
	? `<aside id="${"sidebar-right"}"${add_attribute("class", classesSidebarRight, 0)}>${slots.sidebarRight ? slots.sidebarRight({}) : ``}</aside>`
	: ``}</div>

	
	${$$slots.footer
	? `<footer id="${"shell-footer"}" class="${"flex-none " + escape(classesFooter, true)}">${slots.footer ? slots.footer({}) : ``}</footer>`
	: ``}</main>`;
});

/* C:/Users/Schmi/Projects/lumisxh_master/node_modules/.pnpm/@skeletonlabs+skeleton@0.80.8/node_modules/@skeletonlabs/skeleton/utilities/LightSwitch/LightSwitch.svelte generated by Svelte v3.55.0 */
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
		pageFooter: () => {
			return `<div class="${"flex flex-row justify-around items-center bg-surface-50 dark:bg-surface-800 p-4"}">${validate_component(LightSwitch, "LightSwitch").$$render($$result, {}, {}, {})}
			<h4>Designed by <span class="${"text-primary-400"}">LuMiSxh</span></h4></div>
	`;
		},
		sidebarLeft: () => {
			...
			${validate_component(AppRailTile, "AppRailTile").$$render(
						...
						{},
						{
							default: () => {
								return `${val === 1
								? `${validate_component(Icon, "Icon").$$render($$result, { icon: "mdi:package-variant", width: "35" }, {}, {})}`
