import { c as create_ssr_component, e as escape, b as compute_slots, h as subscribe, v as validate_component } from '../../chunks/index.js';
import { p as page, I as Icon } from '../../chunks/Icon.js';
import '../../chunks/ProgressBar.svelte_svelte_type_style_lang.js';

/* C:/Users/Schmi/Projects/lumisxh_master/node_modules/.pnpm/@skeletonlabs+skeleton@0.80.8/node_modules/@skeletonlabs/skeleton/components/Alert/Alert.svelte generated by Svelte v3.55.0 */
...
const Alert = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.slotContent === void 0 && $$bindings.slotContent && slotContent !== void 0) $$bindings.slotContent(slotContent);
	...
	return `${visible
	? `<div class="${"alert " + escape(classesCard, true)}" data-testid="${"alert"}" role="${"alert"}" aria-live="${"polite"}">
		${$$slots.lead
		? `<section class="${"alert-lead " + escape(classesLead, true)}">${slots.lead ? slots.lead({}) : ``}</section>`
		: ``}

		
		<section class="${"alert-content " + escape(classesContent, true)}">
			${$$slots.title
		? `<h3 class="${"alert-title"}">${slots.title ? slots.title({}) : ``}</h3>`
		: ``}
			
			${$$slots.default
		? `<div class="${"alert-message " + escape(color, true)}">${slots.default ? slots.default({}) : ``}</div>`
		: ``}</section>

		
		${$$slots.trail
		? `<section class="${"alert-trail " + escape(classesTrail, true)}">${slots.trail ? slots.trail({}) : ``}</section>`
		: ``}</div>`
	: ``}`;
});
